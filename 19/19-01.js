...
http.createServer((req,resp)=>{
    ...
    if(req.method=="GET"){
        ...
        if (url.parse(req.url).pathname=="/api/pulpitsWithoutTeachers"){
            resp.writeHead(200,{"Content-Type":"application/json"});
        ...
        if (url.parse(req.url).pathname.includes("api")!==false){
            resp.writeHead(200,{"Content-Type":"application/json"});
            let value=table(url.parse(req.url).pathname.split("/")[2]);
            value.findMany()
    ...
    if (req.method=="POST"){
        if (url.parse(req.url).pathname=="/api/faculties"){
            ...
            req.on('end',  () => { 
                for (let i=0; i<body.PULPIT_PULPIT_FACULTYToFACULTY.length; i++){
                    console.log(body);
                    console.log(body.PULPIT_PULPIT_FACULTYToFACULTY)
                    console.log(body.PULPIT_PULPIT_FACULTYToFACULTY.length)
                    console.log(body.PULPIT_PULPIT_FACULTYToFACULTY[i].PULPIT)
                    console.log(body.PULPIT_PULPIT_FACULTYToFACULTY[i].PULPIT_NAME)
                                    ...
                                    create:{
                                        ...
                                        PULPIT_PULPIT_FACULTYToFACULTY:{
                                            createMany: {
                                                data:[
                                                    {
                                                        PULPIT: body.PULPIT_PULPIT_FACULTYToFACULTY[i].PULPIT,
                                                        PULPIT_NAME: body.PULPIT_PULPIT_FACULTYToFACULTY[i].PULPIT_NAME
                                                    }
                                                ]
                                            }
                                        }
